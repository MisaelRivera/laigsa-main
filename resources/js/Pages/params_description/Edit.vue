<script setup>
    ...
    const handleSubmit = (form$) => {
        ...
        router.put(route('params_description.update', { paramDescription: props.paramDescription.id }), vueformData);
    };
</script>
<template>
    <AuthenticatedLayout>
        <div class="w-6/12 mx-auto">
            ...
            <Vueform
                ...
                <TextareaElement 
                    ...
                    :default="paramDescription.descripcion">
                ...
                <button class="py-2 px-4 rounded text-white bg-blue-500 col-span-2">Editar</button>
            </Vueform>
        </div>
    </AuthenticatedLayout>
</template>